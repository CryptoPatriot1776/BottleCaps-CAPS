...
class TestCapsCli(CapsTestFramework):
    ...
    def run_test(self):
        ...
        self.log.info("Compare responses from getinfo RPC and `caps-cli getinfo`")
        ...
        self.log.info("Compare responses from `caps-cli -getinfo` and the RPCs data is retrieved from.")
