...
import os
import struct
from test_framework.test_framework import CapsTestFramework, SkipTest
...
# noinspection PyUnresolvedReferences
class ZMQTest(CapsTestFramework):
    ...
    def setup_nodes(self):
        ...
        # Check that caps has been built with ZMQ enabled.
        ...
        if not config["components"].getboolean("ENABLE_ZMQ"):
            raise SkipTest("capsd has not been built with zmq enabled.")
