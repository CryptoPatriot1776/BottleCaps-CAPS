...
class AssetTest(CapsTestFramework):
    ...
    def big_test(self):
        ...
        n0.listassets(asset="CAPS*", verbose=False, count=2, start=-2)
        ...
        caps_assets = n0.listassets(asset="CAPS*", verbose=False, count=2, start=-2)
        assert_equal(len(caps_assets), 2)
        assert_equal(caps_assets[0], "CAPS2")
        assert_equal(caps_assets[1], "CAPS3")
        self.sync_all()
