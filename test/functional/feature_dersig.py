...
class BIP66Test(CapsTestFramework):
    ...
    def run_test(self):
        ...
        with mininode_lock:
            ...
            # capsd is running with multiple script check threads. If script
            # check threads are not in use, then transaction script validation
            # happens sequentially, and capsd produces more specific reject
            # reasons.
