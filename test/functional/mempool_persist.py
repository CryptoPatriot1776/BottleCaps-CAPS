...
By default, capsd will dump mempool on shutdown and
...
class MempoolPersistTest(CapsTestFramework):
    ...
    def run_test(self):
        ...
        self.start_node(0)
        self.start_node(1)
        # Give capsd a second to reload the mempool
        time.sleep(1)
        ...
        self.log.debug("Prevent capsd from writing mempool.dat to disk. Verify that `savemempool` fails")
