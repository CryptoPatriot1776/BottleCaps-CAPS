...
# TestNode: A peer we use to send messages to capsd, and store responses.
...
class CompactBlocksTest(CapsTestFramework):
    ...
    # This test actually causes capsd to (reasonably!) disconnect us, so do this last.
    ...
    # Test that capsd requests compact blocks when we announce new blocks
    ...
    def test_incorrect_blocktxn_response(self, node, test_node, version):
        ...
        # Note that it's possible for capsd to be smart enough to know we're
    ...
    def test_getblocktxn_handler(node, test_node, version):
        # capsd will not send blocktxn responses for blocks whose height is
