...
def custom_function():
    ...
    # self.log.info("running custom_function")  # Oops! Can't run self.log outside the CapsTestFramework
    pass

class ExampleTest(CapsTestFramework):
    # Each functional test is a subclass of the CapsTestFramework class.
    ...
    def custom_method(self):
        ...
        CapsTestFramework class so other tests can use it."""
