...
#ifndef CAPSCOIN_ASSET_PROTOCOL_H
#define CAPSCOIN_ASSET_PROTOCOL_H
...
bool CheckIssueDataTx(const CTxOut& txOut); // OP_CAPS_ASSET RVNQ (That is a Q as in Que not an O)
bool CheckOwnerDataTx(const CTxOut& txOut);// OP_CAPS_ASSET RVNO
bool CheckReissueDataTx(const CTxOut& txOut);// OP_CAPS_ASSET RVNR
bool CheckTransferOwnerTx(const CTxOut& txOut);// OP_CAPS_ASSET RVNT
...
#endif //CAPSCOIN_ASSET_PROTOCOL_H
