...
void WalletView::setCapsGUI(CapsGUI *gui)
{
    if (gui)
    {
...
void WalletView::setWalletModel(WalletModel *_walletModel)
{
    ...
    if (_walletModel)
    {
        ...
        // update HD status
        Q_EMIT hdEnabledStatusChanged(_walletModel->hd44Enabled() ? CapsGUI::HD44_ENABLED : _walletModel->hdEnabled() ? CapsGUI::HD_ENABLED : CapsGUI::HD_DISABLED);
