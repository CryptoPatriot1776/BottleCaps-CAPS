...
#ifndef CAPS_QT_GUIUTIL_H
#define CAPS_QT_GUIUTIL_H
...
/** Utility functions used by the Caps Qt UI.
 */
namespace GUIUtil
{
    ...
    // Parse "caps:" URI into recipient object, return true on successful parsing
