    ...
    mapper(0)
{
    ...
    ui->capsAtStartup->setToolTip(ui->capsAtStartup->toolTip().arg(tr(PACKAGE_NAME)));
    ui->capsAtStartup->setText(ui->capsAtStartup->text().arg(tr(PACKAGE_NAME)));

    ui->openCapsConfButton->setToolTip(ui->openCapsConfButton->toolTip().arg(tr(PACKAGE_NAME)));
    ...
    ui->unit->setModel(new CapsUnits(this));
...
{
    /* Main */
    mapper->addMapping(ui->capsAtStartup, OptionsModel::StartAtStartup);
...
void OptionsDialog::on_openCapsConfButton_clicked()
{
