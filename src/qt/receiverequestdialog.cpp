...
#include "config/caps-config.h" /* for USE_QRCODE */
#endif
...
void ReceiveRequestDialog::update()
{
    ...
    QString uri = GUIUtil::formatCapsURI(info);
    ...
    if(info.amount)
        html += "<b>"+tr("Amount")+"</b>: " + CapsUnits::formatHtmlWithUnit(model->getDisplayUnit(), info.amount) + "<br>";
...
{
    GUIUtil::setClipboard(GUIUtil::formatCapsURI(info));
}
