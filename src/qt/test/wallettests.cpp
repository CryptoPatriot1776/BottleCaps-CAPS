...
uint256 SendCoins(CWallet& wallet, SendCoinsDialog& sendCoinsDialog, const CTxDestination& address, CAmount amount, bool rbf)
{
    ...
    entry->findChild<CapsAmountField*>("payAmount")->setValue(amount);
...
//
//     src/qt/test/test_caps-qt -platform xcb      # Linux
//     src/qt/test/test_caps-qt -platform windows  # Windows
//     src/qt/test/test_caps-qt -platform cocoa    # macOS
void TestGUI()
{
    ...
    QString balanceComparison = CapsUnits::formatWithUnit(unit, balance, false, CapsUnits::separatorAlways);
    ...
    // Amount input
    CapsAmountField* amountInput = receiveCoinsDialog.findChild<CapsAmountField*>("reqAmount");
    ...
    for (QWidget* widget : QApplication::topLevelWidgets()) {
        if (widget->inherits("ReceiveRequestDialog")) {
            ...
            QVERIFY(paymentTextList.at(1).indexOf(QString("URI: caps:")) != -1);
