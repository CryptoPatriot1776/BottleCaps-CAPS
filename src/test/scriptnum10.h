...
#ifndef CAPS_TEST_SCRIPTNUM10_H
#define CAPS_TEST_SCRIPTNUM10_H
...
{
/**
 * The ScriptNum implementation from Ravencoin Core 0.10.0, for cross-comparison.
 */
public:
