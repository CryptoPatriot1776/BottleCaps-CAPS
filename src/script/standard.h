...
#ifndef CAPS_SCRIPT_STANDARD_H
#define CAPS_SCRIPT_STANDARD_H
...
enum txnouttype
{
    ...
    TX_RESTRICTED_ASSET_DATA = 11, //!< unspendable OP_CAPS_ASSET script that carries data
    /** RVN END */
};
 ...
 *  A CTxDestination is the internal data type encoded in a capscoin address
 */
...
/**
 * Generate a Caps scriptPubKey for the given CTxDestination. Returns a P2PKH
