...
find ${DISTNAME}/bin -type f -executable -exec ../capscoin/contrib/devtools/split-debug.sh {} {} {}.dbg \;
find ${DISTNAME}/lib -type f -exec ../capscoin/contrib/devtools/split-debug.sh {} {} {}.dbg \;
...
mkdir -p ~/capscoin/depends/SDKs
cp ~/MacOSX10.11.sdk.tar.gz ~/capscoin/depends/SDKs/MacOSX10.11.sdk.tar.gz
