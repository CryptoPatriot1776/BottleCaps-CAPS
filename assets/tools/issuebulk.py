#!/usr/bin/env python3
# Script to issue assets on the Bottlecaps platform
...
# Prerequisite: capsd daemon to be running
...
#mode =  "-regtest"
#rpc_port = 18443
csv_file = "Caps Assets - Sheet1.csv"
#Set this information in your caps.conf file (in datadir, not testnet3)
rpc_user = 'rpcuser'
rpc_pass = 'rpcpass555'
