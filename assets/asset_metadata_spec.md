## Bottlecaps Metadata Specification

Additional fields may be added, but will be ignored by Bottlecaps.
...
```
{
   ...
   "contract_signature": "<Bottlecaps signed contract_hash>",
