Ravencoin Core version *2.1.0* is now available!!
==============

  <https://github.com/CapsProject/Ravencoin/releases/tag/v2.1.0>
...
Changelog available here: <https://github.com/CapsProject/Ravencoin/commits/release_2.1.0>
