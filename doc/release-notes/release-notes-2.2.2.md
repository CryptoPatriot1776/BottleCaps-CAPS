Ravencoin Core version *2.2.2* is now available!!
==============

  <https://github.com/CapsProject/Ravencoin/releases/tag/v2.2.2>
...
Changelog available here: <https://github.com/CapsProject/Ravencoin/commits/release_2.2.2>
