Ravencoin Core version *2.0.4.0* is now available!!
==============

  <https://github.com/CapsProject/Ravencoin/releases/tag/v2.0.4>
...
Changelog available here: <https://github.com/CapsProject/Ravencoin/commits/release_2.0.4>
