...
By default, caps-core allows up to 125 connections to different peers, 12 of
...
limits are tiny. Keep in mind that caps's trustless model works best if you are
