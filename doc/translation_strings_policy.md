...
This document provides guidelines for internationalization of the Ravencoin Core software.
...
This can be checked by executing `make translate` in the `src` directory, then verifying that `caps_en.ts` remains unchanged.
