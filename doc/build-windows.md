...
Below are some notes on how to build Ravencoin Core for Windows.
...
way. This will install to `c:\workspace\caps`, for example:

    make install DESTDIR=/mnt/c/workspace/caps
